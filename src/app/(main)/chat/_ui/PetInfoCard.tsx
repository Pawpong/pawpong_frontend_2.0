...
const PetInfoCard = () => {
  return (
    <div className="flex flex-col bg-white px-5 py-[0.4375rem] shadow-[1px_5px_3.75px_rgba(0,0,0,0.1)] pc:flex-row pc:gap-5 pc:p-5">
      {/* Mobile label */}
      <p className="text-xs leading-[1.5] font-bold text-text-primary pc:hidden">입양문의건</p>
      ...
      <div className="flex gap-[0.5625rem] pc:gap-5">
        ...
        <div className="flex min-w-0 flex-1 flex-col">
          {/* Title */}
          <p className="text-sm leading-[1.5] font-bold text-text-primary pc:hidden">
            레오파드 개코 도마뱀(만다린)
          </p>
          {/* PC Title Row */}
          <div className="hidden items-center gap-[1.125rem] pc:flex">
            ...
            <span className="text-xl leading-[1.375rem] font-semibold text-text-primary">성별</span>
            <span className="size-1 rounded-full bg-fill-muted" />
            <span className="text-xl leading-[1.375rem] font-semibold text-text-primary">
              6개월
            </span>
          ...
          <div className="mt-0.5 flex items-center gap-[0.3125rem] pc:mt-2">
            <Badge variant="status" className="h-[1.375rem] text-xs pc:text-[0.819rem]">
              입양 가능
            </Badge>
            <Badge variant="outline" className="h-[1.375rem] text-xs pc:hidden">
              인기
            </Badge>
          </div>

          {/* PC Description */}
          <p className="mt-3 line-clamp-3 hidden text-xl leading-[1.375rem] font-semibold text-text-primary pc:block">
          ...
          {/* Stats */}
          <div className="mt-auto flex items-center justify-end gap-2 text-[0.625rem] leading-[1.25rem] font-medium text-text-muted pc:gap-5 pc:text-sm pc:leading-[1.375rem]">
            <span>문의 1</span>
            <span>관심 10</span>
            <span>조회 20</span>
          </div>
          ...
          <div className="flex items-center justify-end gap-1 pc:mt-2 pc:gap-[0.625rem]">
            <button
              type="button"
              className="flex items-center gap-1 rounded-full pc:gap-[0.625rem] pc:p-[0.625rem]"
            >
            ...
            <button
              type="button"
              className="hidden items-center gap-[0.625rem] rounded-full p-[0.625rem] pc:flex"
            >
