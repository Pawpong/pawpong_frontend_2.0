...
import { Dialog, DialogPortal, DialogTitle } from '@/shared/ui'
    ...
    <>
      ...
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogPortal>
          ...
          <DialogPrimitive.Content className="fixed top-1/2 left-1/2 z-50 hidden w-[calc(100%-2.5rem)] max-w-[57.25rem] -translate-x-1/2 -translate-y-1/2 overflow-hidden rounded-2xl border border-[#c6c6c6] bg-black tab:block">
