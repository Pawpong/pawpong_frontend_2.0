...
import { StepFieldLabel, StepTextareaWithCounter } from './StepInput'
    ...
    >
      ...
      <div className="flex w-full flex-col">
        ...
        <div className="flex flex-col gap-[0.4375rem]">
          <StepFieldLabel label="반려동물 입양 상담을 위한 개인정보 수집과 이용에 동의하시나요?" required />
        ...
        <div className="mt-[2.0625rem] flex flex-col gap-[0.125rem] tab:mt-[3.625rem]">
          ...
          <StepFieldLabel label="간단하게 자기소개 부탁드려요" required />
          <StepTextareaWithCounter
        ...
        <div className="mt-[2.0375rem] tab:mt-[3.662rem]">
          <StepFieldLabel label="반려동물이 지낼 공간과 생활패턴에 대해 알려주세요" optional />

          <div className="mt-[1.25rem] flex flex-col gap-[1.25rem] tab:mt-3 tab:gap-3">
            <div className="flex flex-col gap-[0.125rem]">
              <StepFieldLabel label="평균적으로 집을 비우는 시간은 얼마나 되나요?" optional />
              <StepTextareaWithCounter
            ...
            <div className="flex flex-col gap-[0.125rem]">
              <StepFieldLabel label="반려동물과 함께 지내게 될 공간을 소개해 주세요" optional />
              <StepTextareaWithCounter
